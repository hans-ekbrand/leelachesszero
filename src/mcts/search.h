...
class SearchWorker {
 ...
 private:
  ...
  void PickNodeToExtendRec(Node *node, Node::Iterator second_best_edge, bool is_root_node, uint16_t depth, int best_node_n, int collision_limit, int& npick);
  void PickNodeToExtend(int collision_limit, int npick);
